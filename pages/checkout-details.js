...
const Home = () => {
  ...
  const onContinue = () => {
    ...
    let isEmpty = Object.values(userDetails).some(value =>  value.trim() === '');
    if(!isEmpty){
  ...
  return (
    <Layout>
      ...
      <Flex alignItems="center" direction="column">
        <Address userDetails={userDetails} setUserDetails={userDetails => dispatch(updateUserDetails(userDetails))} />
